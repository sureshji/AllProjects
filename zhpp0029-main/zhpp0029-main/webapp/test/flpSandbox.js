		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Short Lead Time Approval and Specification Approval",
									"targetURL": "#comyokogawazhpp0029-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comyokogawazhpp0029-display": {
								"semanticObject": "comyokogawazhpp0029",
								"action": "display",
								"description": "Short Lead Time Approval and Specification Approval",
								"title": "Short Lead Time Approval and Specification Approval",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.yokogawa.zhpp0029",
									"url": sap.ui.require.toUrl("com/yokogawa/zhpp0029")
								}
							}
						}
					}
