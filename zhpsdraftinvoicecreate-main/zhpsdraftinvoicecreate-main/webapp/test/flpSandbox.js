		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Draft Invoice",
									"targetURL": "#comyokogawazhpsdraftinvoicecreate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comyokogawazhpsdraftinvoicecreate-display": {
								"semanticObject": "comyokogawazhpsdraftinvoicecreate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.yokogawa.zhpsdraftinvoicecreate",
									"url": sap.ui.require.toUrl("com/yokogawa/zhpsdraftinvoicecreate")
								}
							}
						}
					}
