		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Material Master (Basic Data) I/F In",
									"targetURL": "#comyokogawazhmm0015-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comyokogawazhmm0015-display": {
								"semanticObject": "comyokogawazhmm0015",
								"action": "display",
								"description": "Material Master (Basic Data) I/F In",
								"title": "Material Master (Basic Data) I/F In",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.yokogawa.zhmm0015",
									"url": sap.ui.require.toUrl("com/yokogawa/zhmm0015")
								}
							}
						}
					}
