		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Material Master Reference Report",
									"targetURL": "#comyokogawazhmm0016-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comyokogawazhmm0016-display": {
								"semanticObject": "comyokogawazhmm0016",
								"action": "display",
								"description": "Material Master Reference Report",
								"title": "Material Master Reference Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.yokogawa.zhmm0016",
									"url": sap.ui.require.toUrl("com/yokogawa/zhmm0016")
								}
							}
						}
					}
