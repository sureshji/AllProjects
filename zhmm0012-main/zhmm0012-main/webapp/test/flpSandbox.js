		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Material Code and Production LT Reference",
									"targetURL": "#comyokogawazhmm0012-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comyokogawazhmm0012-display": {
								"semanticObject": "comyokogawazhmm0012",
								"action": "display",
								"description": "Material Code and Production LT Reference.",
								"title": "Material Code and Production LT Reference",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.yokogawa.zhmm0012",
									"url": sap.ui.require.toUrl("com/yokogawa/zhmm0012")
								}
							}
						}
					}
